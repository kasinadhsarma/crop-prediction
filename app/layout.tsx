...
import { Sprout, User, LogOut, Github, Twitter, Linkedin } from 'lucide-react'
      ...
      <body className={`${inter.className} bg-green-50`}>
        ...
        <nav className="bg-[#1B8A3D] text-white p-4 shadow-md">
          <div className="container mx-auto flex justify-between items-center">
            <Link
              href={isAuthenticatedRoute ? '/dashboard' : '/'}
              ...
              {isAuthenticatedRoute ? (
                <>
                  <Link
                    ...
                    className="flex items-center gap-2 text-sm hover:text-green-200 transition-colors duration-200"
                  >
        ...
        {/* Footer - Rendered Only on Non-Auth Pages */}
        {!isAuthenticatedRoute && !isAuthPage && (
          <footer className="bg-green-800 text-white p-8 mt-12">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <h3 className="text-lg font-semibold mb-2">About Us</h3>
                <p className="text-sm text-green-100">
                  Crop Yield Predictor is at the forefront of AI-powered
                  precision agriculture, helping farmers maximize yields and
                  sustainability.
                </p>
              </div>
              <div>
